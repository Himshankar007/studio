'use server';
/**
 * @fileOverview Smart Audio Guide flow that converts text to speech.
 *
...
export async function textToSpeech(input: TextToSpeechInput): Promise<TextToSpeechOutput> {
  return smartAudioGuideFlow(input);
}
...
const smartAudioGuideFlow = ai.defineFlow(
  {
    name: 'smartAudioGuideFlow',
